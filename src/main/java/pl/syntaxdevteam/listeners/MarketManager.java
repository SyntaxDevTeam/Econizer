    ...
    public void onSlashCommandInteraction(@NotNull SlashCommandInteractionEvent event) {
        ...
        if (op.equals("kup")) {
            event.reply("💳 Koszt zakupu **" + ilosc + "x " + ticker + "** wynosi **" + totalCost + " " + settings.currencyEmoji + "**. Wybierz formę płatności:")
                    .addComponents(ActionRow.of(Button.success("st_b_cash:" + ticker + ":" + ilosc + ":" + totalCost, "💵 Gotówką"), Button.primary("st_b_card:" + ticker + ":" + ilosc + ":" + totalCost, "💳 Kartą (z Banku)"))).setEphemeral(true).queue();
        } else {
            event.reply("📈 Chcesz upłynnić **" + ilosc + "x " + ticker + "** za kwotę **" + totalCost + " " + settings.currencyEmoji + "**. Wybierz konto docelowe:")
                    .addComponents(ActionRow.of(Button.success("st_s_cash:" + ticker + ":" + ilosc + ":" + totalCost, "💵 Portfel"), Button.primary("st_s_card:" + ticker + ":" + ilosc + ":" + totalCost, "🏦 Konto Bankowe"))).setEphemeral(true).queue();
        }
    }
