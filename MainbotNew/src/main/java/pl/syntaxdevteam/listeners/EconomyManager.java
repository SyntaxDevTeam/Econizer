...
public class EconomyManager extends ListenerAdapter {
    ...
    public void onSlashCommandInteraction(@NotNull SlashCommandInteractionEvent event) {
        ...
        if (cmd.equals("coinflip")) {
            ...
            event.replyEmbeds(eb.build()).addActionRow(Button.success("cf_pay_cash:" + amt, "💵 Portfel (Gotówka)"), Button.primary("cf_pay_card:" + amt, "💳 Karta (Konto Bankowe)")).setEphemeral(true).queue();
            return;
        }
